...
import { IWellet } from "../interface/wellet.interface";
...
export class Wallet implements IWellet {
    ...
    // 서명 검증
    static verifySignature (message : string, signature : string, publickKey : string) : boolean {
        const hash = Wallet.hashMessage(message);
