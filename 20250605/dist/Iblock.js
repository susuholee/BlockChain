...
//  블록의 생성 시간 : 채굴하고 트랜젝션의 내용이 담긴 생성 시간
...
//  블록의 난이도 : 작업증명 방식에서 블록 생성 시간 목표에 도달하기위해서 사용하는 값 해시문자의 0의 갯수를 난이도로 표현한다.
//     마이닝 작업증명 알고리즘을 풀고 블록의 바디 즉 거래내용을 가지고 해시문자열을 만드는데 
//     논스를 증가시켜서 해시 문자열을 계속 다르게 만들어서 난이도에 도달하면
//     블록을 생성하고 브로드케스트해서 블록생성이 확정되면 보상을 얻는다.
// 바디 ------------
